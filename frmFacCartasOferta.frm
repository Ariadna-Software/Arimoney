...
Begin VB.Form frmFacCartasOferta 
   ...
   Begin VB.TextBox Text1 
      ...
      Text            =   "frmFacCartasOferta.frx":01B4
      Top             =   2925
      Width           =   8835
   End
   Begin VB.TextBox Text1 
   ...
   Begin VB.TextBox Text1 
      ...
      Text            =   "frmFacCartasOferta.frx":01BA
      Top             =   4920
      Width           =   8835
   End
   Begin VB.TextBox Text1 
...
'           .BackColor = &H80000018 'Amarillo claro
            .BackColor = vbWhite
        End If
        ...
        'Código de Carta
        If Index = 0 Then .Text = Format(.Text, "000")
    End With
End Sub
...
Private Sub BotonModificar()
    ...
    'Como el campo1 es clave primaria, NO se puede modificar
...
Dim SQL As String
    ...
    SQL = SQL & "Va a Eliminar la Carta para Ofertas:"
...
On Error GoTo FinEliminar
        ...
        If Data1.Recordset.EOF Then
            ...
            Exit Function
        End If
        SQL = " WHERE codcarta=" & Val(Data1.Recordset!codcarta)
...
Dim Titulo As String
    ...
    'cad = cad & ParaGrid(Text1(2), 15, "Grupo Plant")
    'cad = cad & "Nom. Grupo|sgrupl|nomgrupl|T||25·"
...
'Private Sub SituarDataTrasEliminar(ByRef vData As Adodc, NumReg As Long)
'    vData.Refresh
'    If vData.Recordset.EOF Then    'Solo habia un registro
'        LimpiarCampos
'        PonerModo 0
'    Else
...
Dim SQL As String
On Error Resume Next
    SQL = " WHERE codcarta= " & Text1(0).Text
    ObtenerWhereCP = SQL
End Function
