VERSION 5.00
Begin VB.Form frmPedirConceptos 
   ...
   End
End
Attribute VB_Name = "frmPedirConceptos"
...
Private Sub txtConcepto_GotFocus(Index As Integer)
    ObtenerFocoGral txtConcepto(Index)
End Sub
...
Private Sub txtDiario_GotFocus(Index As Integer)
    ObtenerFocoGral txtDiario(Index)
End Sub
