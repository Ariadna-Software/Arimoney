...
Begin VB.Form frmVerCobrosPagos 
   Caption         =   "Form1"
   ClientHeight    =   5760
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11265
   Icon            =   "frmVerCobrosPagos.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   5760
   ScaleWidth      =   11265
   ...
   Begin VB.Frame FrameTransfer 
      ...
      Begin VB.Image Image1 
         ...
         Index           =   0
         Left            =   10800
         Picture         =   "frmVerCobrosPagos.frx":000C
         ToolTipText     =   "AYUDA"
         Top             =   240
         Width           =   240
      End
      Begin VB.Image imgCheck 
         ...
         Index           =   3
         Left            =   5640
         Picture         =   "frmVerCobrosPagos.frx":010E
      ...
      Begin VB.Image imgCheck 
         ...
         Index           =   2
         Left            =   5640
         Picture         =   "frmVerCobrosPagos.frx":0258
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVerCobrosPagos.frx":03A2
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVerCobrosPagos.frx":5FC4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVerCobrosPagos.frx":62DE
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Frame frame 
      ...
      Begin VB.Frame FrameRemesar 
         ...
         Begin VB.Image imgTraerRestoDatosCliProv 
            ...
            Picture         =   "frmVerCobrosPagos.frx":65F8
            Top             =   120
            Width           =   240
         End
         Begin VB.Image imgFecha 
         ...
         Begin VB.Image imgCheck 
            ...
            Left            =   5400
            MousePointer    =   6  'Size NE SW
            Picture         =   "frmVerCobrosPagos.frx":6FFA
            ToolTipText     =   "Seleccionar todos"
            Top             =   720
            Width           =   240
         End
         Begin VB.Image imgCheck 
            ...
            Left            =   5040
            MousePointer    =   6  'Size NE SW
            Picture         =   "frmVerCobrosPagos.frx":7144
            ToolTipText     =   "Quitar seleccion"
            Top             =   720
            Width           =   240
         End
      ...
      Begin VB.CommandButton cmdRegresar 
         Height          =   615
         Left            =   4200
         Picture         =   "frmVerCobrosPagos.frx":728E
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton Command1 
         Height          =   615
         Left            =   1560
         Picture         =   "frmVerCobrosPagos.frx":7C90
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdDividrVto 
         Height          =   615
         Left            =   5040
         Picture         =   "frmVerCobrosPagos.frx":7F9A
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "frmVerCobrosPagos"
        ...
        If Tipo = 1 And Me.SegundoParametro <> "" Then
            If Not ContabTransfer Then
                ...
                If Cad <> "" Then
                    ...
                    mnQUitarSel.Caption = "Cambiar fecha vencimiento"
                    Me.mnSelectAll.Visible = False
...
Private Sub CargaPagos()
    ...
    If Option1(0).Value Or Option1(3).Value Then
        'CLIENTE
        If Option1(0).Value Then
            Cad = Cad & " spagop.ctaprove,fecefect"
        Else
            Cad = Cad & " nommacta,numfactu,fecfactu"
        End If
...
Dim Aux As String
    If InStr(1, Me.mnQUitarSel.Caption, "fecha") > 0 Then
    
        If ListView1.SelectedItem Is Nothing Then Exit Sub
        
        'Pago domiciliado
        'La opcion es cambiar fecha
        Cad = ""
        Set frmC = New frmCal
        frmC.Fecha = CDate(ListView1.SelectedItem.SubItems(2))
        frmC.Show vbModal
        Set frmC = Nothing
        If Cad <> "" Then
            Stop
            Aux = "Va a poner como fecha de vencimiento: " & Cad
            Aux = Aux & vbCrLf & vbCrLf & "Proveedor: " & ListView1.SelectedItem.SubItems(4)
            Aux = Aux & vbCrLf & "Factura: " & ListView1.SelectedItem.Text & " de " & ListView1.SelectedItem.SubItems(1)
            Aux = Aux & vbCrLf & vbCrLf & " ¿Continuar?"
            If MsgBox(Aux, vbQuestion + vbYesNoCancel) = vbYes Then
                Aux = "UPDATE spagop set fecefect = '" & Format(Cad, "yyyy-mm-dd")
                Aux = Aux & "' WHERE ctaprove = '" & ListView1.SelectedItem.Tag
                Aux = Aux & "' and numfactu= '" & ListView1.SelectedItem.Text
                Aux = Aux & "' and fecfactu= '" & Format(ListView1.SelectedItem.SubItems(1), "yyyy-mm-dd")
                Aux = Aux & "' and numorden= " & ListView1.SelectedItem.SubItems(3)
                If Ejecuta(Aux) Then ListView1.SelectedItem.SubItems(2) = Cad
            End If
        End If
    Else
...
On Error GoTo ERealizarTransferencias
    ...
    impo = 0
    Aux = "" 'para el banco del pago domiciliado
    If RecuperaValor(Me.vTextos, 5) <> "" Then '--> Pago domiciliado
        Aux = RecuperaValor(vTextos, 2)
        I = InStr(1, Aux, "-")
        Aux = Trim(Mid(Aux, 1, I - 1))
   End If
        ...
        With ListView1.ListItems(I)
            If Not Cobros Then
                ...
                If .Checked Then
                    ...
                    'Si es pago domiciliado UPDTEAMOS tambien el banco al que hemos puesto en AUX
                    If Aux <> "" Then Cad = Cad & " , ctabanc1 ='" & Aux & "'"
