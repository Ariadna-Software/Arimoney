...
Dim FrasPro As String
    ...
    If SQL <> "" Then
        ...
        SQL = "Los efectos serán eliminados despues de contabilizar la compensación." & vbCrLf & "¿Continuar?"
        If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then CrearColecciones = True

    Else
        If CampoAnterior = "" Then CampoAnterior = "No se ha selccionado ningún vencimiento."
