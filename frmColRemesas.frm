...
Begin VB.Form frmColRemesas2 
   ...
   End
End
Attribute VB_Name = "frmColRemesas2"
...
Private Sub BotonAnyadir()
    ...
    'Si son efectos o NO
    If Tipo = 1 Then
        frmVarios.SubTipo = vbTipoPagoRemesa
    Else
        frmVarios.SubTipo = vbTalon
    End If
    frmVarios.Show vbModal, Me
...
Case 12
        ...
        If Tipo = 1 Then
            frmVarios.SubTipo = vbTipoPagoRemesa
        Else
            frmVarios.SubTipo = vbTalon 'O pagare, daria lo mismo)
        End If
        frmVarios.Opcion = 17
        frmVarios.Show vbModal
        CargaGrid ""
