...
Dim CtaEfectosComDescontados As String
    ...
    If TipoRemesa = 1 Then
        ...
        Cuenta = "Efectos"
        CuentaPuente = vParam.EfectosCtaPuente
    ...
    ElseIf TipoRemesa = 2 Then
        Linea = vbPagare
        Cuenta = "Pagarés"
        CuentaPuente = vParam.PagaresCtaPuente
        'CtaParametros = "pagarecta"
    Else
        Linea = vbTalon
        Cuenta = "Talones"
        CuentaPuente = vParam.TalonesCtaPuente
...
Dim FecAsto As Date
    ...
    For NF = 1 To ColFechas.Count
        ...
        SQL = SQL & ", 1, NULL, '"
        SQL = SQL & "Abono remesa: " & Codigo & " / " & Anyo & "        XML SEPA"
        SQL = SQL & vbCrLf & "Proceso: " & NF & " / " & ColFechas.Count & vbCrLf
        SQL = SQL & "Generado desde Tesoreria el " & Format(Now, "dd/mm/yyyy") & " por " & vUsu.Nombre & "');"
        If Not Ejecuta(SQL) Then Exit Function
