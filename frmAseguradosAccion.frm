...
Private Sub cmdAviso_Click()
    ...
    Aux = "UPDATE scobro SET feccomunica = '" & Format(Text3(0).Text, FormatoFecha) & "' WHERE " & SQLVto
    If Ejecuta(Aux) Then
...
Private Sub cmdProrroga_Click()
    ...
    Aux = "UPDATE scobro SET fecprorroga = '" & Format(Text3(0).Text, FormatoFecha) & "' WHERE " & SQLVto
    If Ejecuta(Aux) Then
         CadenaDesdeOtroForm = "SI"
        Unload Me
    End If
...
Private Sub cmdSiniestro_Click()
    ...
    Aux = "UPDATE scobro SET fecsiniestro = '" & Format(Text3(0).Text, FormatoFecha) & "' WHERE " & SQLVto
    If Ejecuta(Aux) Then
        CadenaDesdeOtroForm = "SI"
        Unload Me
    End If
