...
Begin VB.Form frmPreguntas 
   ...
   Begin VB.Frame FrameAyudaContabilizacion 
      ...
      Begin VB.TextBox Text1 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   15
         Text            =   "frmPreguntas.frx":0018
         Top             =   720
         Width           =   5175
      End
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmPreguntas.frx":001E
         Left            =   240
         List            =   "frmPreguntas.frx":0031
         Sorted          =   -1  'True
