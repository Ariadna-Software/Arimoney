...
Private Sub Form_Load()
    ...
    'Cadena consulta
    CadenaConsulta = "Select tiporegi,nomregis from contadores where tiporegi>='A'"
    CargaGrid
    'lblIndicador.Caption = ""
End Sub
...
Private Sub CargaGrid(Optional SQL As String)
    ...
    'Nombre producto
    I = 0
        DataGrid1.Columns(I).Caption = "Letra"
